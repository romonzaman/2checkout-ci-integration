...
```shell
$ git clone https://github.com/craigchristenson/2checkout-ci-integration.git
```
...
![](http://github.com/craigchristenson/2checkout-ci-integration/raw/master/img/webwidgets-1.png)
...
------------------------------------
2Checkouts a PHP library provides us with a simple bindings to the API, INS and Checkout process so that we can integrate each feature with only a few lines of code. We can download or clone the library at [https://github.com/craigchristenson/2checkout-php](https://github.com/craigchristenson/2checkout-php).
...
![](http://github.com/craigchristenson/2checkout-ci-integration/raw/master/img/webwidgets-3.png)

**Lets try it out with a live sale.**

![](http://github.com/craigchristenson/2checkout-ci-integration/raw/master/img/webwidgets-2.png)

**Enter in our billing information.**

![](http://github.com/craigchristenson/2checkout-ci-integration/raw/master/img/webwidgets-4.png)

**Submit the payment.**

![](http://github.com/craigchristenson/2checkout-ci-integration/raw/master/img/webwidgets-5.png)
...
![](http://github.com/craigchristenson/2checkout-ci-integration/raw/master/img/webwidgets-6.png)
